...
public class CarCrashDeserializationSchema extends AbstractDeserializationSchema<CarCrash> {
     ...
     */
    @Override
    public CarCrash deserialize(byte[] message) throws IOException {
        return objectMapper.readValue(message, CarCrash.class);
    }
}